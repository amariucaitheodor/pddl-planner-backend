...
class Formula(object):
    ...
    def export(self, lvl=0, sp="  ", untyped=False, grounding=None):
    ...
    def enforce_normalize(self):
        ...
        if not isinstance(self, Oneof) and any([isinstance(child, Forall) for child in self.args]):
            assert False, \
...
class Forall(Formula):
    ...
    def __str__(self):
        ...
        return "forall(%s),(%s)" % (", ".join([v + " " + t for v, t in self.params]), str(self.args[0]))
